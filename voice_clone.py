...
st.set_page_config(page_title="🗣️ Clone Voice TTS", layout="centered")
st.title("🗣️ Text-to-Speech Using Your Voice")
...
# Upload voice sample
speaker_file = st.file_uploader("🎤 Upload your voice sample (.wav)", type=["wav"])

# Text input
text_input = st.text_area("💬 Enter text to speak", placeholder="Type something like: Hello, how are you?")
